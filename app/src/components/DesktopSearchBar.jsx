      ...
      <div className="relative w-full">
        ...
        >
          ...
          {showOwnerAddParking && (
            <>
              <button
                className="qs-owner-map-btn flex items-center whitespace-nowrap px-4 py-2 bg-emerald-800 text-white rounded-lg hover:bg-emerald-900 transition-colors ml-2 focus:ring-emerald-700 focus:outline-none focus:ring-2"
              ...
              <button
                className="qs-owner-location-btn flex items-center whitespace-nowrap px-4 py-2 bg-cyan-800 text-white rounded-lg hover:bg-cyan-900 transition-colors ml-2 focus:ring-cyan-700 focus:outline-none focus:ring-2"
