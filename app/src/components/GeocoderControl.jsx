  ...
  const geocoder = useControl(
    () => {
      const ctrl = new MapboxGeocoder({
        ...props,
        accessToken: props.mapboxAccessToken || MAPBOX_TOKEN,
        marker: false,
      });
      ...
      ctrl.on("result", (evt) => {
        props.onResult(evt); // Llamamos al handler externo (MapPage.jsx)
    ...
    // Posicionamiento en el mapa (propiedad de useControl)
